...
<div id="wrapper">
			...
			<div class="container-fluid">
				...
				<div class="navbar-inner">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="<c:url value="/admin/intro" />">Въведение</a></li>
	...
	<div id="textbox">
		<form action="/app/admin/intro/save" method="post">
			<div class="row">
			    <textarea name="postText" id="postText"><c:out value="${introText}"/></textarea>
	            <script>
